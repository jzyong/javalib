...
//	private static final Vector3 start = new Vector3();
	 ...
	 * 
	 * @param ray
	 *            The ray, the direction component must be normalized before calling
	 *            this method
	 * @param center
	 ...
	 * @param intersection
	 *            The intersection point (optional, can be null)
	 * @return Whether an intersection is present.
	 */
...
//	}
	...
	/**
	 * Quick check whether the given {@link Ray} and  BoundingBox intersect.
	 * 
	 * @param ray
	 *            The ray
	 * @param center
	 ...
	 *            the vertices
	 * @param indices
	 *            the indices, each successive 3 shorts index the 3 vertices of a
	 *            triangle
	 * @param vertexSize
	 ...
	 * @param intersection
	 *            The intersection point. May be null.
...
//	}
	...
	public static void splitTriangle(float[] triangle, Plane plane, SplitTriangle split) {
		...
		boolean r2 = plane.testPoint(triangle[0 + stride], triangle[1 + stride],
				triangle[2 + stride]) == Plane.PlaneSide.Back;
